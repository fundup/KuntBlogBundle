...
namespace Freelance\BlogBundle\DataFixtures\ORM\DefaultSiteGenerator;
...
use Freelance\BlogBundle\Entity\Pages\ContentPage;
use Freelance\BlogBundle\Entity\Pages\HomePage;
