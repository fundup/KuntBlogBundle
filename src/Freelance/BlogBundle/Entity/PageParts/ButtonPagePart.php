 ...
 * ButtonPagePart
 *
 * @ORM\Table(name="freelance_blogbundle_button_page_parts")
 * @ORM\Entity
 */
class ButtonPagePart extends AbstractPagePart
{
    ...
    {
	return 'FreelanceBlogBundle:PageParts:ButtonPagePart/view.html.twig';
    }

    /**
     * Get the admin form type.
     *
     * @return \Freelance\BlogBundle\Form\PageParts\ButtonPagePartAdminType
     */
    public function getDefaultAdminType()
    {
	return new \Freelance\BlogBundle\Form\PageParts\ButtonPagePartAdminType();
    }
}
