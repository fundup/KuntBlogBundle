 ...
 *
 * @ORM\Entity
 * @ORM\Table(name="freelance_blogbundle_image_page_parts")
 */
class ImagePagePart extends AbstractPagePart
{
    ...
    {
	return 'FreelanceBlogBundle:PageParts:ImagePagePart/view.html.twig';
    }

    /**
     * Get the admin form type.
     *
     * @return \Freelance\BlogBundle\Form\PageParts\ImagePagePartAdminType
     */
    public function getDefaultAdminType()
    {
	return new \Freelance\BlogBundle\Form\PageParts\ImagePagePartAdminType();
    }
}
