...
/**
 * @ORM\Entity
 * @ORM\Table(name="freelance_blogbundle_video_page_parts")
 */
class VideoPagePart extends AbstractPagePart
{
    ...
    {
	return "FreelanceBlogBundle:PageParts/VideoPagePart:view.html.twig";
    }
    ...
    {
	return new \Freelance\BlogBundle\Form\PageParts\VideoPagePartAdminType();
    }
}
