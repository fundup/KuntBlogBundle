...
namespace Freelance\BlogBundle\Form\PageParts;

use Freelance\BlogBundle\Entity\PageParts\ButtonPagePart;
...
class ButtonPagePartAdminType extends AbstractType
{
	...
	$resolver->setDefaults(array(
	    'data_class' => '\Freelance\BlogBundle\Entity\PageParts\ButtonPagePart'
	));
    }
}
